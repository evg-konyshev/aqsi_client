...
T = TypeVar("T", bound="NebularApiModelsLkServiceBaseShop")


@_attrs_define
class NebularApiModelsLkServiceBaseShop:
    """Базовая модель магазина

    Example:
        {'name': 'Магазин иллюзий', 'address': {'data': {'city': 'Москва', 'house': '13', 'region': '', 'street': 'ул.
            Кековая', 'country': 'Россия'}, 'value': 'г. Москва, ул. Кековая д.13', 'unrestricted_value': None}, 'url':
            None, 'longitude': None, 'latitude': None, 'onlineStore': True, 'activityType': None, 'customProperties': None}
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_lk_service_base_shop = cls(
            name=name,
            address=address,
            url=url,
            longitude=longitude,
        ...
        return nebular_api_models_lk_service_base_shop
