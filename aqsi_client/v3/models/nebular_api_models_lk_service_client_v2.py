...
T = TypeVar("T", bound="NebularApiModelsLkServiceClientV2")


@_attrs_define
class NebularApiModelsLkServiceClientV2:
    """
    Attributes:
        id (str): <div class="apidocs-russian">Внешний идентификатор клиента</div>
        ...
        birth_date (Union[Unset, datetime.datetime]): <div class="apidocs-russian apidocs-ffd-
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_lk_service_client_v2 = cls(
            id=id,
            group=group,
            fio=fio,
            gender=gender,
        ...
        return nebular_api_models_lk_service_client_v2
