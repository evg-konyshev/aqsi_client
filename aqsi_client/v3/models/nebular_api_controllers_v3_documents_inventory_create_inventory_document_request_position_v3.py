...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsInventoryCreateInventoryDocumentRequestPositionV3")


@_attrs_define
class NebularApiControllersV3DocumentsInventoryCreateInventoryDocumentRequestPositionV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_inventory_create_inventory_document_request_position_v3 = cls(
            quantity=quantity,
            id=id,
        ...
        return nebular_api_controllers_v3_documents_inventory_create_inventory_document_request_position_v3
