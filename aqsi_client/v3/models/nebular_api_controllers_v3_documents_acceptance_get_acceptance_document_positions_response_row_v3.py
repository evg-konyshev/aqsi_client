...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsAcceptanceGetAcceptanceDocumentPositionsResponseRowV3")


@_attrs_define
class NebularApiControllersV3DocumentsAcceptanceGetAcceptanceDocumentPositionsResponseRowV3:
    """
    Attributes:
        ...
        purchase_price (float): <div class="apidocs-russian">Цена закупки</div>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_acceptance_get_acceptance_document_positions_response_row_v3 = cls(
            id=id,
            quantity=quantity,
        ...
        return nebular_api_controllers_v3_documents_acceptance_get_acceptance_document_positions_response_row_v3
