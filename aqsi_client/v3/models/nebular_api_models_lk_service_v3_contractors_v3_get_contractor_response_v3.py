...
T = TypeVar("T", bound="NebularApiModelsLkServiceV3ContractorsV3GetContractorResponseV3")


@_attrs_define
class NebularApiModelsLkServiceV3ContractorsV3GetContractorResponseV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_lk_service_v3_contractors_v3_get_contractor_response_v3 = cls(
            id=id,
        ...
        return nebular_api_models_lk_service_v3_contractors_v3_get_contractor_response_v3
