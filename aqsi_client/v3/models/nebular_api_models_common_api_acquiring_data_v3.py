...
T = TypeVar("T", bound="NebularApiModelsCommonApiAcquiringDataV3")


@_attrs_define
class NebularApiModelsCommonApiAcquiringDataV3:
    """<div class="apidocs-russian">Эквайринговый слип</div>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_common_api_acquiring_data_v3 = cls(
            type_=type_,
            date=date,
        ...
        return nebular_api_models_common_api_acquiring_data_v3
