...
if TYPE_CHECKING:
    from ..models.nebular_api_models_receipt_models_base_client_info import NebularApiModelsReceiptModelsBaseClientInfo
    from ..models.nebular_api_models_receipt_models_base_loyalty_content import (
...
T = TypeVar("T", bound="NebularApiModelsReceiptModelsReceiptV3")


@_attrs_define
class NebularApiModelsReceiptModelsReceiptV3:
    """Модель чека версии 3
    ...
    Attributes:
        ...
        document_index (Union[Unset, int]): <div class="apidocs-russian">Номер чека за смену</div>
        ...
        order_id (Union[None, UUID, Unset]): <div class="apidocs-russian">Идентификатор заказа, для которого пробит
            чек</div>
        ...
        loyalty_content (Union['NebularApiModelsReceiptModelsBaseLoyaltyContent', None, Unset]): <div class="apidocs-
        ...
        client_info (Union['NebularApiModelsReceiptModelsBaseClientInfo', None, Unset]): <div class="apidocs-
    ...
    order_id: Union[None, UUID, Unset] = UNSET
    ...
    loyalty_content: Union["NebularApiModelsReceiptModelsBaseLoyaltyContent", None, Unset] = UNSET
    client_info: Union["NebularApiModelsReceiptModelsBaseClientInfo", None, Unset] = UNSET
    return_check_id: Union[None, UUID, Unset] = UNSET

    def to_dict(self) -> dict[str, Any]:
        from ..models.nebular_api_models_receipt_models_base_client_info import (
        ...
        elif isinstance(self.loyalty_content, NebularApiModelsReceiptModelsBaseLoyaltyContent):
        ...
        if isinstance(self.client_info, Unset):
            client_info = UNSET
        elif isinstance(self.client_info, NebularApiModelsReceiptModelsBaseClientInfo):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_index = d.pop("documentIndex", UNSET)
        ...
        def _parse_order_id(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_loyalty_content(
            data: object,
        ) -> Union["NebularApiModelsReceiptModelsBaseLoyaltyContent", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                loyalty_content_type_1 = NebularApiModelsReceiptModelsBaseLoyaltyContent.from_dict(data)

                return loyalty_content_type_1
            except:  # noqa: E722
                pass
            return cast(Union["NebularApiModelsReceiptModelsBaseLoyaltyContent", None, Unset], data)

        loyalty_content = _parse_loyalty_content(d.pop("loyaltyContent", UNSET))

        def _parse_client_info(data: object) -> Union["NebularApiModelsReceiptModelsBaseClientInfo", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                client_info_type_1 = NebularApiModelsReceiptModelsBaseClientInfo.from_dict(data)

                return client_info_type_1
            except:  # noqa: E722
                pass
            return cast(Union["NebularApiModelsReceiptModelsBaseClientInfo", None, Unset], data)
        ...
        nebular_api_models_receipt_models_receipt_v3 = cls(
            content=content,
        ...
        return nebular_api_models_receipt_models_receipt_v3
