...
T = TypeVar("T", bound="NebularApiModelsCommonApiCredit")


@_attrs_define
class NebularApiModelsCommonApiCredit:
    """<div class="apidocs-russian">Информация о зачислении бонусов на карту</div>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_common_api_credit = cls(
            hash_=hash_,
            pan4=pan4,
            slip=slip,
            cheque=cheque,
        ...
        return nebular_api_models_common_api_credit
