...
T = TypeVar("T", bound="NebularApiModelsLkServiceReceiptsV2ClientInfo")


@_attrs_define
class NebularApiModelsLkServiceReceiptsV2ClientInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_lk_service_receipts_v2_client_info = cls(
            id=id,
            discount_card=discount_card,
            input_method=input_method,
        )

        return nebular_api_models_lk_service_receipts_v2_client_info
