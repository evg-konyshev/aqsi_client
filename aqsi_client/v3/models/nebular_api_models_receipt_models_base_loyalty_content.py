...
T = TypeVar("T", bound="NebularApiModelsReceiptModelsBaseLoyaltyContent")


@_attrs_define
class NebularApiModelsReceiptModelsBaseLoyaltyContent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_receipt_models_base_loyalty_content = cls(
            disc_amount=disc_amount,
            net_amount=net_amount,
            gross_amount=gross_amount,
        )

        return nebular_api_models_receipt_models_base_loyalty_content
