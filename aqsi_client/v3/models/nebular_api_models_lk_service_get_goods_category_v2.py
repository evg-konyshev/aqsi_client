...
if TYPE_CHECKING:
    ...
    from ..models.nebular_api_models_lk_service_get_goods_category import NebularApiModelsLkServiceGetGoodsCategory


T = TypeVar("T", bound="NebularApiModelsLkServiceGetGoodsCategoryV2")


@_attrs_define
class NebularApiModelsLkServiceGetGoodsCategoryV2:
    """Модель дерева товарных категорий V2
    ...
    Attributes:
        ...
        id (Union[None, Unset, str]): <div class="apidocs-russian">Идентификатор категории</div>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_lk_service_get_goods_category_v2 = cls(
        ...
        return nebular_api_models_lk_service_get_goods_category_v2
