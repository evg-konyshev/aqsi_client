...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsAcceptanceCreateAcceptanceDocumentRequestPositionV3")


@_attrs_define
class NebularApiControllersV3DocumentsAcceptanceCreateAcceptanceDocumentRequestPositionV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_acceptance_create_acceptance_document_request_position_v3 = cls(
            quantity=quantity,
        ...
        return nebular_api_controllers_v3_documents_acceptance_create_acceptance_document_request_position_v3
