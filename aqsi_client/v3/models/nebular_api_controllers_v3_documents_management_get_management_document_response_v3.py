...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsManagementGetManagementDocumentResponseV3")


@_attrs_define
class NebularApiControllersV3DocumentsManagementGetManagementDocumentResponseV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_management_get_management_document_response_v3 = cls(
            warehouse=warehouse,
            id=id,
        ...
        return nebular_api_controllers_v3_documents_management_get_management_document_response_v3
