...
from ...models.nebular_api_controllers_v3_documents_movement_create_movement_document_request_v3 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/documents/movement",
    }

    if isinstance(body, NebularApiControllersV3DocumentsMovementCreateMovementDocumentRequestV3):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (NebularApiControllersV3DocumentsMovementCreateMovementDocumentRequestV3):
        body (NebularApiControllersV3DocumentsMovementCreateMovementDocumentRequestV3):
        body (NebularApiControllersV3DocumentsMovementCreateMovementDocumentRequestV3):
