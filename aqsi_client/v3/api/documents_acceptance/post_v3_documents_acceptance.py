...
from ...models.nebular_api_controllers_v3_documents_acceptance_create_acceptance_document_request_v3 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/documents/acceptance",
    }

    if isinstance(body, NebularApiControllersV3DocumentsAcceptanceCreateAcceptanceDocumentRequestV3):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (NebularApiControllersV3DocumentsAcceptanceCreateAcceptanceDocumentRequestV3):
        body (NebularApiControllersV3DocumentsAcceptanceCreateAcceptanceDocumentRequestV3):
        body (NebularApiControllersV3DocumentsAcceptanceCreateAcceptanceDocumentRequestV3):
