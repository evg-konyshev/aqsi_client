...
def sync_detailed(
    ...
    *,
    ...
    r"""Delete
     ...
     <div class=\"apidocs-russian\"><span>Удаление магазина внешней системы</span><br><div
    ...
    english\">Delete external system shop</div><br/><div class=\"apidocs-russian version-annotation\">В
