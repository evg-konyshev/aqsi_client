...
from ...models.nebular_api_models_lk_service_base_shop import NebularApiModelsLkServiceBaseShop
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/v2/Shops/{shop_id}",
    }

    if isinstance(body, NebularApiModelsLkServiceBaseShop):
...
def sync_detailed(
    ...
    *,
    ...
    r"""Update
     ...
     <div class=\"apidocs-russian\"><span>Обновление магазина для внешней системы</span><br><div
    ...
    english\">Update external system shop</div><br/><div class=\"apidocs-russian version-annotation\">В
    методах версии 2 (V2) идентификаторы уникальны в разрезе аккаунта (используются идентификаторы
    внешней системы заказчика), в отличие от методов версии 1 (V1), где использовались идентификаторы
    уникальные в разрезе всей системы.</div>
    ...
    Args:
        ...
        body (NebularApiModelsLkServiceBaseShop): Базовая модель магазина Example: {'name':
