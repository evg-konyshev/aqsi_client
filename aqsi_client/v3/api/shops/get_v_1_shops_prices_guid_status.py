...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/ShopsPrices/{guid}/status",
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Set Prices Status
     ...
     <div class=\"apidocs-russian\"><span>Получение статуса загрузки пачки сообщений по
    ...
    заполнению</div></div><div class=\"apidocs-english\">Get goods batch message status by ID</div>
