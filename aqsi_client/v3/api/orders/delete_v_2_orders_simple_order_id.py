...
def sync_detailed(
    ...
    *,
    ...
    r"""Delete
     ...
     <div class=\"apidocs-russian\"><span>Удаление данных об отложенном заказе, принимает в качестве
    параметра на вход внешний id, с которым был создан данный заказ во внешней системе</span><br><div
    ...
    english\">Deleting data on a pending order, takes as an input parameter the external id with which
    this order was created in the external system</div><br/><div class=\"apidocs-russian version-
