...
def sync_detailed(
    *,
    ...
    r"""Update
     ...
     <div class=\"apidocs-russian\"><span>Обновление товара в личном кабинете в разрезе аккаунта,в ответе
    ...
    english\">External system account-wide goods updating. Response returns data bus message queuing
