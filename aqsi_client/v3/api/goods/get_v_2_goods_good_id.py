...
from ...models.nebular_api_models_lk_service_extended_good_v2 import NebularApiModelsLkServiceExtendedGoodV2
...
) -> Optional[Union[NebularApiModelsCommonApiErrorModel, NebularApiModelsLkServiceExtendedGoodV2]]:
    if response.status_code == 200:
        response_200 = NebularApiModelsLkServiceExtendedGoodV2.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[NebularApiModelsCommonApiErrorModel, NebularApiModelsLkServiceExtendedGoodV2]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Read
     ...
     <div class=\"apidocs-russian\"><span>Получение товара из личного кабинета в разрезе
    ...
    заполнению</div></div><div class=\"apidocs-english\">Get external system goods
    information</div><br/><div class=\"apidocs-russian version-annotation\">В методах версии 2 (V2)
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[NebularApiModelsCommonApiErrorModel, NebularApiModelsLkServiceExtendedGoodV2]
    """
