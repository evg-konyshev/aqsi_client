...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v2/ListGoodsCategories/{guid}/status",
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Bulk Upsert Status
     ...
     <div class=\"apidocs-russian\"><span>Получение статуса загрузки пачки сообщений для категорий по
    ...
    заполнению</div></div><div class=\"apidocs-english\">Get goods categories batch message status by
    ID</div>
