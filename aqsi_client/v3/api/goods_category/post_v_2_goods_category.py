...
from ...models.nebular_api_dtos_good_category_dto_v2 import NebularApiDtosGoodCategoryDtoV2
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v2/GoodsCategory",
    }

    if isinstance(body, NebularApiDtosGoodCategoryDtoV2):
...
def sync_detailed(
    *,
    ...
    r"""Create
     ...
     <div class=\"apidocs-russian\"><span>Создание категории в личном кабинете в разрезе аккаунта,в
    ответе возвращается время постановки сообщения в очередь на шину данных</span><br><div
    ...
    english\">External system account-wide goods category creation. Response returns data bus message
    queuing timestamp</div><br/><div class=\"apidocs-russian version-annotation\">В методах версии 2
    ...
    Args:
        ...
        body (NebularApiDtosGoodCategoryDtoV2): Товарная категория
        body (NebularApiDtosGoodCategoryDtoV2): Товарная категория
        body (NebularApiDtosGoodCategoryDtoV2): Товарная категория
