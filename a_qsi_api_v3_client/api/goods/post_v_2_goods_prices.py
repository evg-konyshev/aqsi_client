...
from ...models.nebular_api_models_lk_service_goods_v2_set_prices import NebularApiModelsLkServiceGoodsV2SetPrices
...
def _get_kwargs(
    *,
    body: Union[
        list["NebularApiModelsLkServiceGoodsV2SetPrices"],
        list["NebularApiModelsLkServiceGoodsV2SetPrices"],
        list["NebularApiModelsLkServiceGoodsV2SetPrices"],
    ],
    ...
    if isinstance(body, list["NebularApiModelsLkServiceGoodsV2SetPrices"]):
        _json_body = []
...
def sync_detailed(
    *,
    ...
    r"""Set Prices
     ...
     <div class=\"apidocs-russian\"><span>Установить цены товарам и привязать их к
    магазинам.</span><br><div class=\"required-annotation\">Поля в модели запроса, отмеченные <span
    style=\"color: red; font-weight: normal;\">required</span> - обязательны к
    заполнению</div></div><div class=\"apidocs-english\">Set goods prices and associate it with
    shops.</div><br/><div class=\"apidocs-russian version-annotation\">В методах версии 2 (V2)
    ...
    Args:
        ...
        body (list['NebularApiModelsLkServiceGoodsV2SetPrices']):  Example: [{'id': 'ITEM_ID',
            'shops': [{'id': 'SHOP_ID', 'price': '25', 'maxDiscountPercent': '20'}], 'defaultPrice':
            '17.5'}].
        body (list['NebularApiModelsLkServiceGoodsV2SetPrices']):  Example: [{'id': 'ITEM_ID',
            'shops': [{'id': 'SHOP_ID', 'price': '25', 'maxDiscountPercent': '20'}], 'defaultPrice':
            '17.5'}].
