...
from ...models.nebular_api_controllers_v3_documents_write_off_create_write_off_document_request_v3 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/documents/write-off",
    }

    if isinstance(body, NebularApiControllersV3DocumentsWriteOffCreateWriteOffDocumentRequestV3):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (NebularApiControllersV3DocumentsWriteOffCreateWriteOffDocumentRequestV3):
        body (NebularApiControllersV3DocumentsWriteOffCreateWriteOffDocumentRequestV3):
        body (NebularApiControllersV3DocumentsWriteOffCreateWriteOffDocumentRequestV3):
