...
) -> Optional[Union[NebularApiModelsCommonApiErrorModel, list["NebularApiModelsLkServiceGetShopV2"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = NebularApiModelsLkServiceGetShopV2.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[NebularApiModelsCommonApiErrorModel, list["NebularApiModelsLkServiceGetShopV2"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    r"""Index
     ...
     <div class=\"apidocs-russian\"><span>Получение всех магазинов внешней системы</span><br><div
    ...
    english\">Get all external system shops</div><br/><div class=\"apidocs-russian version-
...
def sync(
    *,
    ...
    Returns:
        Union[NebularApiModelsCommonApiErrorModel, list['NebularApiModelsLkServiceGetShopV2']]
    """
