...
from ...models.nebular_api_controllers_v3_documents_production_create_production_document_request_v3 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v3/documents/production",
    }

    if isinstance(body, NebularApiControllersV3DocumentsProductionCreateProductionDocumentRequestV3):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (NebularApiControllersV3DocumentsProductionCreateProductionDocumentRequestV3):
        body (NebularApiControllersV3DocumentsProductionCreateProductionDocumentRequestV3):
        body (NebularApiControllersV3DocumentsProductionCreateProductionDocumentRequestV3):
