...
def sync_detailed(
    ...
    *,
    ...
    r"""Delete
     ...
     <div class=\"apidocs-russian\"><span>Удаление клиента внешней системы</span><br><div
    ...
    english\">Client delete for external system</div><br/><div class=\"apidocs-russian version-
