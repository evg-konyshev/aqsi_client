...
from ...models.nebular_api_models_lk_service_client_v2 import NebularApiModelsLkServiceClientV2
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, NebularApiModelsLkServiceClientV2):
...
def sync_detailed(
    *,
    ...
    r"""Create
     ...
     <div class=\"apidocs-russian\"><span>Создание клиента для внешней системы</span><br><div
    ...
    english\">Create external system client</div><br/><div class=\"apidocs-russian version-
    ...
    Args:
        ...
        body (NebularApiModelsLkServiceClientV2):
        body (NebularApiModelsLkServiceClientV2):
        body (NebularApiModelsLkServiceClientV2):
