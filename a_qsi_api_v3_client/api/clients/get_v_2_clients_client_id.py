...
from ...models.nebular_api_models_lk_service_client_extended_v2 import NebularApiModelsLkServiceClientExtendedV2
...
) -> Optional[Union[NebularApiModelsCommonApiErrorModel, NebularApiModelsLkServiceClientExtendedV2]]:
    if response.status_code == 200:
        response_200 = NebularApiModelsLkServiceClientExtendedV2.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[NebularApiModelsCommonApiErrorModel, NebularApiModelsLkServiceClientExtendedV2]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Read
     ...
     <div class=\"apidocs-russian\"><span>Получение данных клиента для внешней системы</span><br><div
    ...
    english\">Getting external system client data</div><br/><div class=\"apidocs-russian version-
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[NebularApiModelsCommonApiErrorModel, NebularApiModelsLkServiceClientExtendedV2]
    """
