...
def sync_detailed(
    *,
    ...
    r"""Update
     ...
     <div class=\"apidocs-russian\"><span>Обновление категории в личном кабинете в разрезе аккаунта,в
    ...
    english\">External system account-wide goods category update. Response returns data bus message
