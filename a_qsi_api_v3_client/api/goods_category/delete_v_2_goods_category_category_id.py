...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/v2/GoodsCategory/{category_id}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Delete
     ...
     <div class=\"apidocs-russian\"><span>Удаление категории в личном кабинете в разрезе аккаунта,в
    ...
    english\">External system account-wide goods category deletion. Response returns data bus message
