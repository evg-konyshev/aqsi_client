...
from ...models.nebular_api_controllers_v3_documents_inventory_create_inventory_document_request_v3 import (
...
def _get_kwargs(
    *,
    ...
    if isinstance(body, NebularApiControllersV3DocumentsInventoryCreateInventoryDocumentRequestV3):
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        body (NebularApiControllersV3DocumentsInventoryCreateInventoryDocumentRequestV3):
        body (NebularApiControllersV3DocumentsInventoryCreateInventoryDocumentRequestV3):
        body (NebularApiControllersV3DocumentsInventoryCreateInventoryDocumentRequestV3):
