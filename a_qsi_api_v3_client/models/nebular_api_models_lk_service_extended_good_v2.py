...
if TYPE_CHECKING:
    ...
    from ..models.nebular_api_models_lk_service_goods_shop_info import NebularApiModelsLkServiceGoodsShopInfo
    from ..models.nebular_api_models_lk_service_img import NebularApiModelsLkServiceImg
    from ..models.nebular_api_models_lk_service_modifier_good import NebularApiModelsLkServiceModifierGood
...
T = TypeVar("T", bound="NebularApiModelsLkServiceExtendedGoodV2")


@_attrs_define
class NebularApiModelsLkServiceExtendedGoodV2:
    """
    Attributes:
        ...
        shops (Union[None, Unset, list['NebularApiModelsLkServiceGoodsShopInfo']]): <div class="apidocs-russian">Массив
            магазинов, к которым привязан товар</div>
        ...
        subject (Union[None, Unset, str]): <div class="apidocs-russian apidocs-ffd-availability">Соответствует: ФФД
            1.05, ФФД 1.2</div>
            <div class="apidocs-english apidocs-ffd-availability">Available in: FFD 1.05, FFD 1.2</div>
        ...
        barcodes (Union[None, Unset, list[str]]): <div class="apidocs-russian">Штрих-коды товаров (максимальная длина
            одного штрих-кода - 64 символа)</div>
        ...
        marking_type (Union[NebularApiEnumsMarkingTypeEnum, None, Unset]): <div class="apidocs-russian">Тип маркировки
            ...
            oil</div></div>
        modifiers (Union[None, Unset, list['NebularApiModelsLkServiceModifierGood']]): <div class="apidocs-
            russian">Массив модификаторов товара </div>
    ...
    shops: Union[None, Unset, list["NebularApiModelsLkServiceGoodsShopInfo"]] = UNSET
    ...
    is_weight: Union[Unset, int] = UNSET
    ...
    is_orderable: Union[Unset, bool] = UNSET
    ...
    non_tradable: Union[Unset, bool] = UNSET
    marking_type: Union[NebularApiEnumsMarkingTypeEnum, None, Unset] = UNSET
    modifiers: Union[None, Unset, list["NebularApiModelsLkServiceModifierGood"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        shops: Union[None, Unset, list[dict[str, Any]]]
        if isinstance(self.shops, Unset):
            shops = UNSET
        elif isinstance(self.shops, list):
            shops = []
            for shops_type_0_item_data in self.shops:
                shops_type_0_item = shops_type_0_item_data.to_dict()
                shops.append(shops_type_0_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_shops(data: object) -> Union[None, Unset, list["NebularApiModelsLkServiceGoodsShopInfo"]]:
            if data is None:
                return data
            ...
            try:
                ...
                shops_type_0 = []
                _shops_type_0 = data
                for shops_type_0_item_data in _shops_type_0:
                    shops_type_0_item = NebularApiModelsLkServiceGoodsShopInfo.from_dict(shops_type_0_item_data)

                    shops_type_0.append(shops_type_0_item)

                return shops_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, Unset, list["NebularApiModelsLkServiceGoodsShopInfo"]], data)
        ...
        def _parse_modifiers(data: object) -> Union[None, Unset, list["NebularApiModelsLkServiceModifierGood"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for modifiers_type_0_item_data in _modifiers_type_0:
                    modifiers_type_0_item = NebularApiModelsLkServiceModifierGood.from_dict(modifiers_type_0_item_data)
                ...
                pass
            return cast(Union[None, Unset, list["NebularApiModelsLkServiceModifierGood"]], data)
        ...
        nebular_api_models_lk_service_extended_good_v2 = cls(
            id=id,
            group_id=group_id,
        ...
        return nebular_api_models_lk_service_extended_good_v2
