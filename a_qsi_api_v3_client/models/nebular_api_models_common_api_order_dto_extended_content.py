...
if TYPE_CHECKING:
    ...
    from ..models.nebular_api_models_common_api_order_dto_extended_position import (
...
T = TypeVar("T", bound="NebularApiModelsCommonApiOrderDtoExtendedContent")


@_attrs_define
class NebularApiModelsCommonApiOrderDtoExtendedContent:
    ...
    <div class="apidocs-english">Content</div>
        ...
        Attributes:
            type_ (Union[NebularApiEnumsDocTypeEnum, None, Unset]): <div class="apidocs-russian apidocs-ffd-
                ...
                return</div></div>
            positions (Union[None, Unset, list['NebularApiModelsCommonApiOrderDtoExtendedPosition']]): <div class="apidocs-
    ...
    positions: Union[None, Unset, list["NebularApiModelsCommonApiOrderDtoExtendedPosition"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_positions(
            data: object,
        ) -> Union[None, Unset, list["NebularApiModelsCommonApiOrderDtoExtendedPosition"]]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for positions_type_0_item_data in _positions_type_0:
                    positions_type_0_item = NebularApiModelsCommonApiOrderDtoExtendedPosition.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["NebularApiModelsCommonApiOrderDtoExtendedPosition"]], data)
        ...
        nebular_api_models_common_api_order_dto_extended_content = cls(
            type_=type_,
            positions=positions,
        ...
        return nebular_api_models_common_api_order_dto_extended_content
