...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsWriteOffCreateWriteOffDocumentRequestPositionV3")


@_attrs_define
class NebularApiControllersV3DocumentsWriteOffCreateWriteOffDocumentRequestPositionV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_write_off_create_write_off_document_request_position_v3 = cls(
            quantity=quantity,
            id=id,
        ...
        return nebular_api_controllers_v3_documents_write_off_create_write_off_document_request_position_v3
