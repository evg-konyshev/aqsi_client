...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsInventoryGetInventoryDocumentResponseV3")


@_attrs_define
class NebularApiControllersV3DocumentsInventoryGetInventoryDocumentResponseV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_inventory_get_inventory_document_response_v3 = cls(
            warehouse=warehouse,
            id=id,
        ...
        return nebular_api_controllers_v3_documents_inventory_get_inventory_document_response_v3
