...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsWriteOffGetWriteOffDocumentPositionsResponseRowV3")


@_attrs_define
class NebularApiControllersV3DocumentsWriteOffGetWriteOffDocumentPositionsResponseRowV3:
    """
    Attributes:
        ...
        reason (Union[None, Unset, str]): <div class="apidocs-russian">Причина списания</div>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_write_off_get_write_off_document_positions_response_row_v3 = cls(
            id=id,
            quantity=quantity,
            reason=reason,
        ...
        return nebular_api_controllers_v3_documents_write_off_get_write_off_document_positions_response_row_v3
