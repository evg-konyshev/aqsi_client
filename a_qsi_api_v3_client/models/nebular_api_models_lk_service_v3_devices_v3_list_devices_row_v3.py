...
T = TypeVar("T", bound="NebularApiModelsLkServiceV3DevicesV3ListDevicesRowV3")


@_attrs_define
class NebularApiModelsLkServiceV3DevicesV3ListDevicesRowV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_lk_service_v3_devices_v3_list_devices_row_v3 = cls(
            id=id,
            imei=imei,
        ...
        return nebular_api_models_lk_service_v3_devices_v3_list_devices_row_v3
