...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsInventoryGetInventoryDocumentPositionsResponseRowV3")


@_attrs_define
class NebularApiControllersV3DocumentsInventoryGetInventoryDocumentPositionsResponseRowV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_inventory_get_inventory_document_positions_response_row_v3 = cls(
            id=id,
            quantity=quantity,
        ...
        return nebular_api_controllers_v3_documents_inventory_get_inventory_document_positions_response_row_v3
