...
T = TypeVar("T", bound="NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRequestPositionV3")


@_attrs_define
class NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRequestPositionV3:
    """
    Attributes:
        ...
        purchase_price (float): <div class="apidocs-russian">Цена закупки. Макс.кол-во знаков после запятой: 2.
            Существует только у документов Приемка и Оприходование</div>
        ...
        reason (Union[None, Unset, str]): <div class="apidocs-russian">Причина оприходования или списания. Существует
            только у документов Оприходование и Списание</div>
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_lk_service_v3_documents_v3_create_document_request_position_v3 = cls(
            quantity=quantity,
        ...
        return nebular_api_models_lk_service_v3_documents_v3_create_document_request_position_v3
