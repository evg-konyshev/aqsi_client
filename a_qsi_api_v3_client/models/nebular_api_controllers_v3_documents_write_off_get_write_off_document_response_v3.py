...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsWriteOffGetWriteOffDocumentResponseV3")


@_attrs_define
class NebularApiControllersV3DocumentsWriteOffGetWriteOffDocumentResponseV3:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_controllers_v3_documents_write_off_get_write_off_document_response_v3 = cls(
            warehouse=warehouse,
            id=id,
        ...
        return nebular_api_controllers_v3_documents_write_off_get_write_off_document_response_v3
