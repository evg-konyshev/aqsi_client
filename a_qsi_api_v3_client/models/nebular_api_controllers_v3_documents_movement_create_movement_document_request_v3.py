...
if TYPE_CHECKING:
    ...
    from ..models.nebular_api_models_lk_service_v3_documents_v3_create_document_request_position_v3 import (
        NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRequestPositionV3,
    )


T = TypeVar("T", bound="NebularApiControllersV3DocumentsMovementCreateMovementDocumentRequestV3")


@_attrs_define
class NebularApiControllersV3DocumentsMovementCreateMovementDocumentRequestV3:
    """
    Attributes:
        warehouse (NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRelatedEntityV3):
        positions (list['NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRequestPositionV3']): <div class="apidocs-
            russian">Список позиций документа.</div>
            <div class="apidocs-english">Document positions list</div>
        from_warehouse (NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRelatedEntityV3):
    ...
    warehouse: "NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRelatedEntityV3"
    positions: list["NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRequestPositionV3"]
    from_warehouse: "NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRelatedEntityV3"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for positions_item_data in _positions:
            positions_item = NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRequestPositionV3.from_dict(
                positions_item_data
            )

            positions.append(positions_item)

        from_warehouse = NebularApiModelsLkServiceV3DocumentsV3CreateDocumentRelatedEntityV3.from_dict(
            d.pop("fromWarehouse")
        )
        ...
        nebular_api_controllers_v3_documents_movement_create_movement_document_request_v3 = cls(
            warehouse=warehouse,
            positions=positions,
        ...
        return nebular_api_controllers_v3_documents_movement_create_movement_document_request_v3
