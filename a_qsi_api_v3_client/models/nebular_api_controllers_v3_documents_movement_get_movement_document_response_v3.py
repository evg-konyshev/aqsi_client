...
T = TypeVar("T", bound="NebularApiControllersV3DocumentsMovementGetMovementDocumentResponseV3")


@_attrs_define
class NebularApiControllersV3DocumentsMovementGetMovementDocumentResponseV3:
    """
    Attributes:
        ...
        from_warehouse (NebularApiModelsLkServiceV3DocumentsV3GetDocumentRelatedEntityV3):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from_warehouse = self.from_warehouse.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from_warehouse = NebularApiModelsLkServiceV3DocumentsV3GetDocumentRelatedEntityV3.from_dict(
            d.pop("fromWarehouse")
        )
        ...
        nebular_api_controllers_v3_documents_movement_get_movement_document_response_v3 = cls(
            warehouse=warehouse,
            id=id,
        ...
        return nebular_api_controllers_v3_documents_movement_get_movement_document_response_v3
