...
T = TypeVar("T", bound="NebularApiModelsCommonApiOrderDtoPosition")


@_attrs_define
class NebularApiModelsCommonApiOrderDtoPosition:
    """
    Attributes:
        ...
        sold_amount (Union[Unset, float]): <div class="apidocs-russian">Количество проданного товара</div>
    ...
    sold_amount: Union[Unset, float] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        nebular_api_models_common_api_order_dto_position = cls(
            quantity=quantity,
            price=price,
            tax=tax,
        ...
        return nebular_api_models_common_api_order_dto_position
